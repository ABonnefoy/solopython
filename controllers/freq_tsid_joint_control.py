...
class Freq_TSID_Joint_Control:
    
    def __init__(self, logSize = None, dt = 0.01, q_disp = np.zeros(8)):
	...
	# Dynamics Problem initialization
        ...
        self.trajPosture = tsid.TrajectoryEuclidianConstant("traj_joint", q_ref+self.q_disp) # Goal = static
